...
$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$replaceText[$message;Z;Z҉];Y;Y҉];X;X҉];W;W҉];V;V҉];U;U҉];T;T҉];S;S҉];R;R҉];Q;Q҉];P;P҉];O;O҉];Ñ;Ñ];N;N҉];M;M҉];L;L҉];K;];J;J҉];I;I҉];H;H҉];G;G҉];F;F҉];E;];D;D҉];C;C҉];B;B҉];A;A҉];z;];y;y҉];x;x҉];w;];v;v҉];u;u҉];t;t҉];s;s҉];r;];q;q҉];p;p҉];o;o҉];ñ;ñ];n;n҉];m;m҉];l;l҉];k;k҉];j;j҉];i;i҉];h;h҉];g;g҉];f;f҉];e;e҉];d;d҉];c;c҉];b;b҉];a;a҉]
